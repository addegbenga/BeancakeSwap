      ...
      <div className="container  justify-center  lg:mx-auto  flex flex-col-reverse  lg:flex-row  items-center px-3 pt-20 pb-10">
        <div className="py-10 lg:max-w-xl lg:mt-20">
          ...
          <div className="flex gap-3 my-5">
            <button className="bg-[#1fc7d4] rounded text-white text-lg px-8 border-2 border-[#1fc7d4] p-2">
              Get Started
            </button>
            <button className="border-[#1fc7d4] rounded text-[#1fc7d4] border-2 px-8 p-2">
              Trade Now
            </button>
          </div>
        </div>
